...
import { Materials, MaterialType } from "@/app/lib/definitions"
import { 
    Square3Stack3DIcon,
    PencilIcon,
    BeakerIcon,
...
import { updateMaterial } from "@/app/lib/actionsMaterials";
                    ...
                    <div className="relative mt-2 rounded-md">
                        <div className="relative">
                             <select 
                                ...
                                name="materialtypeid"
                                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                                defaultValue={material.materialtypeid}
                                aria-describedby="materialType-error"
                            >
                                <option value="" disabled>
                                    Selecciona un tipo de Material
                                </option>
                                {materialtypes.map((materialtypes) => (
                                    <option key={materialtypes.materialtypeid} value={materialtypes.materialtypeid}>
                                        {materialtypes.name}
                                    </option>
                                ))}
                            </select>
